...
echo tra("Camicia is a distributed-computing project that exhaustively searches every distinct deal of a 52-card deck, looking for games of Beggar-My-Neighbour (named after the Italian card game in the same family, though the two differ in rules) that loop forever, or that take unusually long to end. Every volunteer's computer tests a different slice of the deck, so together we cover every possible deal exactly once.");
