...
function get_job_status() {
    // Camicia fix: get_cached_data() returns null on a cold/expired cache,
    // and passing null to unserialize() is deprecated as of PHP 8.1 --
    // this showed up as a visible deprecation notice on the live page
    // (project.inc's display_errors() is deliberately on). Guard the call
    // instead of passing a possibly-null value straight through.
